...
In DSH Web and DSH Desktop, open **Settings → Plugins** to edit the private
CIDR allowlist, exact allowed hosts, and private-DNS switch. Saved values are
stored in the DSH settings document and take effect for newly started
`web_fetch` requests.
